...
void Obfuscator::buildPreservedSet() {
    ...
    // Common entry points
    std::vector<std::string> extra = {"main","Main","__main__","__name__","__init__","__import__","setup_hook","on_ready","close","change_presence","sync","constructor","printf","scanf","cout","cin","include","define","import","from","require","module","exports","console","log","print","len","range","str","int","float","list","dict","base64","urllib","codecs","html","json","discord","aiohttp","asyncio","logging","typing","Optional","app_commands","bot","BrixBot","TOKEN","API_KEY","BASE_URL","SEARCH_ENDPOINT","API_TIMEOUT","MAX_RESULTS","LOG_LEVEL","intents","session","logger","tree","client","lookup","ping","interaction","nom","prenom","email","telephone","ville","flexible","payload","response","data","results","meta","total","remaining_day","error_msg","embed","color","title","description","inline","name","value","headers","timeout","json","per_page","Exception","TimeoutError","ClientError","AttributeError","HTTPException","LoginFailure","ValueError","Optional","ClientSession","CommandTree","Intents","Embed","Game","JSONDecodeError","post","get","request","debug","info","warning","error","exception","add_field","set_footer","send","defer","followup"};
